...
public class adapter_Rooms extends FirebaseRecyclerAdapter<Rooms,adapter_Rooms.myviewholder> {
    Rooms room;

    public adapter_Rooms(@NonNull FirebaseRecyclerOptions<Rooms> options) {
        super(options);
        room = new Rooms();
    }
