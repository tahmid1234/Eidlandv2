...
public class ConstantApp {
    ...
    public static List<GiftItem> giftList(){
        ...
        giftItems.add(new GiftItem("smilereact",1, R.drawable.ic_gift___heart_1));
        giftItems.add(new GiftItem("hearts",1, R.drawable.ic_gift___heart_3));
        giftItems.add(new GiftItem("heartcomment",1, R.drawable.ic_gift___heart_2));
        giftItems.add(new GiftItem("like1",1, R.drawable.ic_gift___like_1));
        giftItems.add(new GiftItem("like2",1, R.drawable.ic_gift___like_2));
        ...
        giftItems.add(new GiftItem("fire",1, R.drawable.ic_gift___fire));
    ...
    public static List<AnimationItem> animationItems(){
        ...
        animationItemList.add(new AnimationItem("hearts", R.drawable.ic_heart, R.drawable.sweets));
        animationItemList.add(new AnimationItem("like1", R.drawable.ic_like_1, R.drawable.neck));
        animationItemList.add(new AnimationItem("smilereact", R.drawable.ic_heart_1_, R.drawable.cookies));
